...
bot = telebot.TeleBot("MAH:502966091:AAELP1ur4cMXHAzwThdRJgXdtDzXSLhRUEw")
...
def send_info (message):
        bot.send_message(message.chat.id, "JPG.HD! \n \nБот написан и протестиро$
